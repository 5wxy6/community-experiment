...
async function experimentInit() {
  ...
  // 框架文本已移至模块级常量 FRAMING_TEXT_GROUP / FRAMING_TEXT_INDIV
  ...
  emotion_text_anger_1 = new visual.TextStim({
    ...
    pos: [0, 0.43], draggable: false, height: 0.035, wrapWidth: 1.3, ori: 0.0,
  ...
  emotion_text_anger_2 = new visual.TextStim({
    ...
    text: '', font: 'STHeiti', units: undefined,
    pos: [0, 0.26], draggable: false, height: 0.035, wrapWidth: 1.3, ori: 0.0,
  ...
  emotion_text_anger_3 = new visual.TextStim({
    ...
    text: '', font: 'STHeiti', units: undefined,
    pos: [0, 0.09], draggable: false, height: 0.035, wrapWidth: 1.3, ori: 0.0,
  ...
  emotion_text_anger_4 = new visual.TextStim({
    ...
    text: '', font: 'STHeiti', units: undefined,
    pos: [0, (- 0.08)], draggable: false, height: 0.035, wrapWidth: 1.3, ori: 0.0,
  ...
  emotion_text_anger_5 = new visual.TextStim({
    ...
    text: '', font: 'STHeiti', units: undefined,
    pos: [0, (- 0.25)], draggable: false, height: 0.035, wrapWidth: 1.3, ori: 0.0,
  ...
  emotion_slider_anger_1 = new visual.Slider({
    ...
    size: [1.0, 0.05], pos: [0, 0.39], ori: 0.0, units: psychoJS.window.units,
    labels: ["1\n非常不认同", "2\n比较不认同", "3\n有点不认同", "4\n不确定", "5\n有点认同", "6\n比较认同", "7\n非常认同"],
  ...
  emotion_slider_anger_2 = new visual.Slider({
    ...
    size: [1.0, 0.05], pos: [0, 0.22], ori: 0.0, units: psychoJS.window.units,
    labels: ["1\n非常不认同", "2\n比较不认同", "3\n有点不认同", "4\n不确定", "5\n有点认同", "6\n比较认同", "7\n非常认同"],
    fontSize: 0.025, ticks: [1, 2, 3, 4, 5, 6, 7], granularity: 1.0,
    style: ["RATING", "LABELS_20", "TRIANGLE_MARKER"],
    color: new util.Color('black'), markerColor: new util.Color('Red'), lineColor: new util.Color('White'),
  ...
  emotion_slider_anger_4 = new visual.Slider({
    ...
    size: [1.0, 0.05], pos: [0, - 0.12], ori: 0.0, units: psychoJS.window.units,
    labels: ["1\n非常不认同", "2\n比较不认同", "3\n有点不认同", "4\n不确定", "5\n有点认同", "6\n比较认同", "7\n非常认同"],
    fontSize: 0.025, ticks: [1, 2, 3, 4, 5, 6, 7], granularity: 1.0,
    style: ["RATING", "LABELS_20", "TRIANGLE_MARKER"],
    color: new util.Color('black'), markerColor: new util.Color('Red'), lineColor: new util.Color('White'),
  ...
  emotion_slider_anger_5 = new visual.Slider({
    ...
    size: [1.0, 0.05], pos: [0, - 0.29], ori: 0.0, units: psychoJS.window.units,
    labels: ["1\n非常不认同", "2\n比较不认同", "3\n有点不认同", "4\n不确定", "5\n有点认同", "6\n比较认同", "7\n非常认同"],
    fontSize: 0.025, ticks: [1, 2, 3, 4, 5, 6, 7], granularity: 1.0,
    style: ["RATING", "LABELS_20", "TRIANGLE_MARKER"],
    color: new util.Color('black'), markerColor: new util.Color('Red'), lineColor: new util.Color('White'),
